...
msquares.prototype =
{
	...
	stroke: function( mouseX, mouseY )
	{
		...
		this.context.beginPath();
		this.context.moveTo(WIDTH - this.prevMouseX - px, this.prevMouseY - py);
		this.context.lineTo(WIDTH - this.prevMouseX + px, this.prevMouseY + py);
		this.context.lineTo(WIDTH - mouseX + px, mouseY + py);
		this.context.lineTo(WIDTH - mouseX - px, mouseY - py);
		this.context.lineTo(WIDTH - this.prevMouseX - px, this.prevMouseY - py);
		this.context.fill();
		this.context.stroke();
